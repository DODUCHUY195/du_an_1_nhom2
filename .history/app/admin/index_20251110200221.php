...
switch($route){
    ...
    case '/schedules/create':
         $c = new ScheduleController();
          $c->create(); 
          break;
    case (preg_match('#^/schedules/edit/(\d+)$#', $route, $m) ? true : false): 
        $c = new ScheduleController();
         $c->edit($m[1]); 
         break;
    case '/guides':
    ...
    case '/guides/create':
         $c = new GuideController();
          $c->create();
           break;
    case (preg_match('#^/guides/edit/(\d+)$#', $route, $m) ? true : false):
         $c = new GuideController();
          $c->edit($m[1]);
           break;
    case '/categories':
    ...
    case '/admin/bookings/update':
         $c = new AdminBookingController();
          $c->updateStatus(); 
          break;
    default: echo "<h1>Welcome</h1><p><a href='/tours'>Tours</a></p>";
}
