...
define('APP_PATH', dirname(__DIR__)); // nếu file đang ở /app/admin thì APP_PATH -> .../du_an_11/app

// ----- require các file chung -----
$commonsEnv  = APP_PATH . '/commons/env.php';
$commonsFunc = APP_PATH . '/commons/function.php';

if (!file_exists($commonsEnv)) die("Missing file: $commonsEnv");
if (!file_exists($commonsFunc)) die("Missing file: $commonsFunc");

require_once $commonsEnv;
require_once $commonsFunc;

// ----- require tất cả models -----
$models = [
    APP_PATH . '/admin/models/BaseModel.php',
    APP_PATH . '/admin/models/Booking.php',
    APP_PATH . '/admin/models/Category.php',
    APP_PATH . '/admin/models/Guide.php',
    APP_PATH . '/admin/models/Schedule.php',
    APP_PATH . '/admin/models/Tour.php',
    APP_PATH . '/admin/models/User.php',
];
...
$controllers = [
    APP_PATH . '/admin/controllers/BaseController.php',
    APP_PATH . '/admin/controllers/AdminBookingController.php',
    APP_PATH . '/admin/controllers/AuthController.php',
    APP_PATH . '/admin/controllers/BookingController.php',
    APP_PATH . '/admin/controllers/CategoryController.php',
    APP_PATH . '/admin/controllers/GuideController.php',
    APP_PATH . '/admin/controllers/HomeController.php',
    APP_PATH . '/admin/controllers/ScheduleController.php',
    APP_PATH . '/admin/controllers/TourController.php',
];
