...
<main class="relative h-full max-h-screen transition-all xl:ml-68 rounded-xl">
    ...
    <div class="w-full p-6 mx-auto">
        ...
        <form action="<?= BASE_URL . '?route=/categories/postEdit' ?>" method="POST">
            ...
            <div class="mb-4">
                <textarea name="description" id="" class="focus:shadow-primary-outline dark:bg-gray-950 dark:placeholder:text-white/80 dark:text-white/80 text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding p-3 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" placeholder="Nhập mô tả"><?= $danhMuc['mo_ta'] ?></textarea>
