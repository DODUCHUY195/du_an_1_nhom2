              ...
              <table class="items-center w-full mb-0 align-top border-collapse dark:border-white/40 text-slate-500">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-warning" href="<?= BASE_URL . '?act=formsuadanhmuc&id_danh_muc=' . $danhMuc['id'] ?>">

                      </a>
                      <a class="btn btn-danger" href="<?= BASE_URL . '?act=xoadanhmuc&id_danh_muc=' . $danhMuc['id'] ?>" onclick="return confirm('Bạn có đồng ý xoá không')"><i class="fas fa-trash-alt"></i></a>
