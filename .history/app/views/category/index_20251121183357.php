                  ...
                  <tr>
                    ...
                    <td>
                      <div class="inline-flex rounded-md shadow-sm" role="group">
                        <a
                          href="#"
                          class="px-3 py-1 text-sm bg-blue-600 hover:bg-blue-700 text-white rounded-l-md">
                          Sửa
                        </a>

                        <a
                          href="#"
                          class="px-3 py-1 text-sm bg-red-600 hover:bg-red-700 text-white rounded-r-md">
                          Xóa
                        </a>
                      </div>
                    </td>
