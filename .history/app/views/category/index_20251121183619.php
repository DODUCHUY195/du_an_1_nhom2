            ...
            <div class="p-0 overflow-x-auto">
              <table class="items-center w-full mb-0 align-top border-collapse dark:border-white/40 text-slate-500">
                ...
                <tbody>
                  ...
                  <tr>
                    <td class="flex gap-2 justify-center"><?= $key + 1 ?></td>
                    <td class="flex gap-2 justify-center"><?= $danhMuc['category_name'] ?></td>

                    <td class="flex gap-2 justify-center"><?= $danhMuc['description'] ?></td>
                    <td class="flex gap-2 justify-center">
                      <a
                        href="<?= BASE_URL . '?route=/categories/editForm&category_id=' . $danhMuc['category_id'] ?>"
                        class="px-3 py-1 bg-blue-600 hover:bg-blue-700 text-black rounded-md text-sm">
                        Sửa
                      </a>

                      <a
                        href="#"
                        class="px-3 py-1 bg-red-600 hover:bg-red-700 text-black rounded-md text-sm">
                        Xóa
                      </a>
                    </td>
                  </tr>
