...
<?php require_once "./views/layouts/manager/header.php"; ?>

<?php require_once  "./views/layouts/manager/sidebar.php"; ?>

<main class="relative h-full max-h-screen transition-all xl:ml-68 rounded-xl pt-20">

    <?php require_once  "./views/layouts/manager/navbar.php"; ?>
...
<?php require_once  "./views/layouts/manager/footer.php"; ?>
