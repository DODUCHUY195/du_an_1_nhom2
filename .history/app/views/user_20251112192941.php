...
<head>
  ...
  <!-- Favicons -->
  <link href="/du_an_11/app/admin//du_an_11/app/admin/assetsss/img/favicon.png" rel="icon">
  <link href="/du_an_11/app/admin//du_an_11/app/admin/assetsss/img/apple-touch-icon.png" rel="apple-touch-icon">
  ...
  <!-- Vendor CSS Files -->
  <link href="/du_an_11/app/admin//du_an_11/app/admin/assetsss/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <link href="/du_an_11/app/admin//du_an_11/app/admin/assetsss/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
  <link href="/du_an_11/app/admin//du_an_11/app/admin/assetsss/vendor/aos/aos.css" rel="stylesheet">
  <link href="/du_an_11/app/admin//du_an_11/app/admin/assetsss/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">
  <link href="/du_an_11/app/admin//du_an_11/app/admin/assetsss/vendor/glightbox/css/glightbox.min.css" rel="stylesheet">

  <!-- Main CSS File -->
  <link href="/du_an_11/app/admin/assetss/css/main.css" rel="stylesheet">
...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="header-container container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto me-xl-0">
        ...
        <!-- <img src="/du_an_11/app/admin/assetss/img/logo.webp" alt=""> -->
    ...
    <section id="travel-hero" class="travel-hero section dark-background">
      ...
      <div class="hero-background">
        <video autoplay="" muted="" loop="">
          <source src="/du_an_11/app/admin/assetss/img/travel/video-2.mp4" type="video/mp4">
        </video>
        ...
        <div class="row align-items-center mb-5">
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
            <div class="about-image">
              <img src="/du_an_11/app/admin/assetss/img/travel/showcase-8.webp" alt="Travel Experience" class="img-fluid rounded-4">
          ...
          <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="featured-destination">
              <div class="destination-overlay">
                <img src="/du_an_11/app/admin/assetss/img/travel/destination-3.webp" alt="Tropical Paradise" class="img-fluid">
          ...
          <div class="col-lg-6">
            <div class="row g-3">
              ...
              <div class="col-12" data-aos="fade-left" data-aos-delay="300">
                <div class="compact-destination">
                  <div class="destination-image">
                    <img src="/du_an_11/app/admin/assetss/img/travel/destination-7.webp" alt="Mountain Adventure" class="img-fluid">
              ...
              <div class="col-12" data-aos="fade-left" data-aos-delay="400">
                <div class="compact-destination">
                  <div class="destination-image">
                    <img src="/du_an_11/app/admin/assetss/img/travel/destination-11.webp" alt="Cultural Heritage" class="img-fluid">
                  </div>
                  <div class="destination-details">
              ...
              <div class="col-12" data-aos="fade-left" data-aos-delay="500">
                <div class="compact-destination">
                  <div class="destination-image">
                    <img src="/du_an_11/app/admin/assetss/img/travel/destination-16.webp" alt="Safari Experience" class="img-fluid">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4">
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="tour-card">
              <div class="tour-image">
                <img src="/du_an_11/app/admin/assetss/img/travel/tour-1.webp" alt="Serene Beach Retreat" class="img-fluid" loading="lazy">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="tour-card">
              <div class="tour-image">
                <img src="/du_an_11/app/admin/assetss/img/travel/tour-2.webp" alt="Arctic Expedition" class="img-fluid" loading="lazy">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="tour-card">
              <div class="tour-image">
                <img src="/du_an_11/app/admin/assetss/img/travel/tour-4.webp" alt="Desert Safari" class="img-fluid" loading="lazy">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="tour-card">
              <div class="tour-image">
                <img src="/du_an_11/app/admin/assetss/img/travel/tour-5.webp" alt="Coastal Explorer" class="img-fluid" loading="lazy">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="tour-card">
              <div class="tour-image">
                <img src="/du_an_11/app/admin/assetss/img/travel/tour-6.webp" alt="Rainforest Trek" class="img-fluid" loading="lazy">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="tour-card">
              <div class="tour-image">
                <img src="/du_an_11/app/admin/assetss/img/travel/tour-8.webp" alt="Patagonian Peaks" class="img-fluid" loading="lazy">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <img src="/du_an_11/app/admin/assetss/img/person/person-m-9.webp" class="testimonial-img" alt="">
                <h3>Saul Goodman</h3>
                <h4>Ceo &amp; Founder</h4>
              </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <img src="/du_an_11/app/admin/assetss/img/person/person-f-5.webp" class="testimonial-img" alt="">
                <h3>Sara Wilsson</h3>
                <h4>Designer</h4>
              </div>
            </div><!-- End testimonial item -->
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <img src="/du_an_11/app/admin/assetss/img/person/person-f-12.webp" class="testimonial-img" alt="">
                <h3>Jena Karlis</h3>
                <h4>Store Owner</h4>
              </div>
            </div><!-- End testimonial item -->
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <img src="/du_an_11/app/admin/assetss/img/person/person-m-12.webp" class="testimonial-img" alt="">
                <h3>Matt Brandon</h3>
                <h4>Freelancer</h4>
              </div>
            </div><!-- End testimonial item -->
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <img src="/du_an_11/app/admin/assetss/img/person/person-m-13.webp" class="testimonial-img" alt="">
                <h3>John Larson</h3>
                <h4>Entrepreneur</h4>
              </div>
            </div><!-- End testimonial item -->
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="hero-content" data-aos="zoom-in" data-aos-delay="200">
          ...
          <div class="visual-element">
            <img src="/du_an_11/app/admin/assetss/img/travel/showcase-3.webp" alt="Travel Adventure" class="hero-image" loading="lazy">
  ...
  <!-- Vendor JS Files -->
  <script src="/du_an_11/app/admin/assetss/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="/du_an_11/app/admin/assetss/vendor/php-email-form/validate.js"></script>
  <script src="/du_an_11/app/admin/assetss/vendor/aos/aos.js"></script>
  <script src="/du_an_11/app/admin/assetss/vendor/purecounter/purecounter_vanilla.js"></script>
  <script src="/du_an_11/app/admin/assetss/vendor/swiper/swiper-bundle.min.js"></script>
  <script src="/du_an_11/app/admin/assetss/vendor/isotope-layout/isotope.pkgd.min.js"></script>
  <script src="/du_an_11/app/admin/assetss/vendor/imagesloaded/imagesloaded.pkgd.min.js"></script>
  <script src="/du_an_11/app/admin/assetss/vendor/glightbox/js/glightbox.min.js"></script>

  <!-- Main JS File -->
  <script src="/du_an_11/app/admin/assetss/js/main.js"></script>
