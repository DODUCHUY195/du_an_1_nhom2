    ...
    <div class="w-full p-6 mx-auto">
        ...
        <form action="<?= BASE_URL . '?route=/categories/postAdd' ?>" method="POST">
            ...
            <div class="mb-4">
                ...
                <input id="category_name" type="text" name="category_name" placeholder="Nhập tên danh mục" required 
            ...
            <div class="mb-4">
                ...
                <input id="description" type="text" name="description" placeholder="Nhập mô tả" 
                       class="focus:shadow-primary-outline dark:bg-gray-950 dark:placeholder:text-white/80 dark:text-white/80 
                       text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 
                       bg-white bg-clip-padding p-3 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 
                       focus:border-fuchsia-300 focus:outline-none" />
            ...
            <div class="text-center">
                <button type="submit" 
                        ...
                        hover:shadow-xs text-sm ease-in tracking-tight-rem shadow-md bg-150 bg-x-25">Thêm danh mục</button>
            </div>
