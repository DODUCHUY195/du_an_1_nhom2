...
<nav class="relative flex flex-wrap items-center justify-between px-0 py-2 mx-6 mb-6 transition-all ease-in shadow-none duration-250 rounded-2xl ">
    <div class="flex items-center justify-between w-full px-4 py-1 mx-auto">
        ...
        <nav>
            <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                ...
                <li class="text-sm pl-2 capitalize leading-normal text-black before:content-['/']"
                    aria-current="page">
                    <?= $page_title ?? "Dashboard" ?>
                </li>
            </ol>
            <h6 class="mb-0 font-bold text-black capitalize"><?= $page_title ?? "Dashboard" ?></h6>
        </nav>
