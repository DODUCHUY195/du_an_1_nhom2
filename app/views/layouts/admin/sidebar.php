...
<aside class="fixed inset-y-0 flex-wrap items-center justify-between block w-full p-0 my-4 overflow-y-auto antialiased transition-transform duration-200 -translate-x-full bg-white border-0 shadow-xl dark:shadow-none dark:bg-slate-850 max-w-64 ease-nav-brand z-990 xl:ml-6 rounded-2xl xl:left-0 xl:translate-x-0" aria-expanded="false">
    ...
    <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full ">
        <ul class="flex flex-col pl-0 mb-0">
              ...
              <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 <?= active('/tours') ?>"
                   href="<?= BASE_URL . '?route=/bookings' ?>">
                    ...
                    <span class="ml-1 duration-300 opacity-100 ease">Booking</span>
                </a>
            </li>
            ...
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 <?= active('/schedules/tourDiary') ?>"
                   href="<?= BASE_URL . '?route=/schedules/tourDiary' ?>">
                    <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg text-center">
                        <i class="relative top-0 text-sm leading-normal text-blue-500 ni ni-single-copy-04"></i>
                    </div>
                    <span class="ml-1 duration-300 opacity-100 ease">Nhật Ký Tour</span>
                </a>
            </li>
