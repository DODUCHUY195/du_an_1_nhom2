    ...
    <div class="bg-white rounded-xl shadow p-6 mb-6">
      <form method="GET" action="<?= BASE_URL ?>" class="space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <!-- Category filter -->
          <div>
            <label for="category_id" class="block mb-2 font-medium text-gray-700">Danh mục</label>
            <select id="category_id" name="category_id" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent">
